...
<body>
    <div class="container">
        ...
        <p>This dashboard shows the most frequently occurring hashes in your 'decenhash' database, along with their daily activity over the last 30 days.</p>
            ...
            <?php foreach ($topHashes as $hashData): ?>
                <div class="hash-item">
                    <h3>
                        ...
                        <span class="count">Total Count: <?php echo $hashData['count']; ?></span>
                    </h3>
                    ...
                    if ($stmtDailyCounts) {
                        ...
                        echo "Error preparing daily counts statement: " . $mysqli->error;
                    }
