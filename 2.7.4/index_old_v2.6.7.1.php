                ...
                if ($fileSaved) {
                    ...
                    if (touch($categoryFilePath)) {
                        ...
                        if (isset($_POST['url']) && !empty($_POST['url'])) {
                            ...
                            $fileImage = '<a href="' . htmlspecialchars($_POST['url']) . '"><img src="' . htmlspecialchars($_POST['url']) . '"></a><br>';
                            $fileImageCategory = '<a href="' . htmlspecialchars($_POST['url']) . '"><img src="' . htmlspecialchars($_POST['url']) . '"></a><br>';
                        }

                        if (strtolower($fileExtension) === 'jpg' || strtolower($fileExtension) === 'png') {
                            $fileImage = '<a href="' . htmlspecialchars($fileNameWithExtension) . '"><img src="' . htmlspecialchars($fileNameWithExtension) . '"></a><br>';
                            $fileImageCategory = '<a href="../' . $fileHash . '/' . htmlspecialchars($fileNameWithExtension) . '"><img src="../' . $fileHash . '/' . htmlspecialchars($fileNameWithExtension) . '"></a><br>';
                        } 
  
                        $linkLike = '<a href="../../like.php?reply=' . htmlspecialchars($fileHash) . '">' . "<img src='../../icons/thumb_up.png' alt='[ Like ]'>" . '</a> ';
                        ...
                        $linkToFileFolderIndex = $linkToHash . '<a href="' . htmlspecialchars($fileNameWithExtension) . '">' . htmlspecialchars($originalFileName) . '</a><br>' . $fileImage; //Use original file name or 'text_content.txt' for link text
                        ...
                        $categoryLike = '<a href="../../like.php?reply=' . htmlspecialchars($fileHash) . '">' . "<img src='../../icons/thumb_up.png' alt='[ Like ]'>" . '</a> ';
                        ...
                        $linkToCategoryFolderIndex = $linkToHashCategory . '<a href="' . htmlspecialchars($relativePathToFile) . '">' . htmlspecialchars($originalFileName) . '</a><br>' . $fileImageCategory; //Use original file name or 'text_content.txt' for link text
