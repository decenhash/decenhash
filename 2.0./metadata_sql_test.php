...
// Create the `file_search_test` table if it doesn't exist
$createTableQuery = "
CREATE TABLE IF NOT EXISTS file_search_test (
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($title)) {
        ...
        if (!empty($finalHash) && !empty($extension)) {
            // Insert data into the database
            $stmt = $conn->prepare("INSERT INTO file_search_test (title, username, description, file_hash, image_hash, extension) VALUES (?, ?, ?, ?, ?, ?)");
