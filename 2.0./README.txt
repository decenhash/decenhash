...
The goal of the project is to implement a system that can verify which servers host the same file and 
develop mechanisms to reward users the more their files are distributed.
