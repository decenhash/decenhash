...
$totalEntries = 0;
$sqlTotalEntries = "SELECT COUNT(*) as total_count FROM hashstock";
...
$topHashes = [];
$sqlTopHashes = "SELECT filehash, COUNT(*) as count FROM hashstock GROUP BY filehash ORDER BY count DESC LIMIT 20";
    ...
    <div class="container">
        ...
        <?php else: ?>
            <?php foreach ($topHashes as $hashData): ?>
                ...
                <div class="hash-item">
                    <h3>
                        <span>Hash: **<?php echo htmlspecialchars($hashData['filehash']); ?>**</span>
                    ...
                    $sqlDailyCounts = "SELECT DATE(date) as date, COUNT(*) as daily_count
                                       FROM hashstock
                    ...
                    if ($stmtDailyCounts) {
                        $stmtDailyCounts->bind_param("s", $hashData['filehash']);
