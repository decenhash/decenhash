...
<head>
    ...
    <title>Decenhash - Simple Sharing System</title>
    <style>
...
<?php endif; ?>
        ...
        <section class="info-section">
            <h1>DECENHASH</h1>
            <p>Decenhash is a simple sharing system that allows rewards based on the number of accesses of a file or URL.</p>
            <ul>
                <li>Run without MySQL</li>
                <li>You can submit a URL or a file (if you submit both, the user will be redirected to the file).</li>
                <li>The system prevents duplicate entries using <strong>SHA-256 hashes</strong>.</li>
                <li>File information is saved in <strong>JSON</strong> format</li>
            </ul>
            ...
            <div class="account-section">
                ...
                <div class="account-tiers">
                    ...
                    <div class="account-tier junior">
                        <div class="tier-name">Junior Account</div>
                        <div class="tier-price">$1.00</div>
                        <ul class="tier-features">
                            <li>Persistent and non-expiring storage</li>                            
                        </ul>
                    </div>
                    
                    <!-- Pro Account -->
                    <div class="account-tier pro">
                        <div class="tier-name">Pro Account</div>
                        <div class="tier-price">$10.00</div>
                        <ul class="tier-features">
                            <li>Earn rewards for popular files or links that you sent</li>
                            <li>Increase your daily insert limit</li> 
                        </ul>
                    </div>
                    
                    <!-- Master Account -->
                    <div class="account-tier master">
                        <div class="tier-name">Master Account</div>
                ...
                <div class="payment-methods">
                    <div class="payment-icons">                       
                        <a href="https://t.me/devsacramento" style="text-decoration: none;" class="purchase-button" >Purchase</a>
                    </div>
                </div>
            </div>
        </section>
    ...
    <script>
        function performSearch() {
            ...
            if (searchTerm) {
                // Make a GET request to search.php with the search term
