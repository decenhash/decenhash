            ...
            if ($fileContent !== null) { // Proceed if we have either file content or text content
                ...
                if ($fileSaved) {
                    ...
                    if (touch($categoryFilePath)) {
                        ...
                        $linkReply = $linkLike . '<a href="../../index_simple.php?reply=' . htmlspecialchars($fileHash) . '">' . "<img src='../../icons/arrow_undo.png' alt='[ Reply ]'>" . '</a> ';
                        ...
                        $categoryReply = $categoryLike . '<a href="../../index_simple.php?reply=' . htmlspecialchars($fileHash) . '">' . "<img src='../../icons/arrow_undo.png' alt='[ Reply ]'>" . '</a> ';
